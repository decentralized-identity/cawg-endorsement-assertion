...
* **ODRL Permissions Assertion 1.0-draft**: Complete replacement of Endorsement Assertion with ODRL-based approach.
* Introduced CAWG ODRL Profile for C2PA with standard ODRL 2.2 compliance.
* Added JSON-LD context for C2PA-specific extensions.
* Implemented Offer → Agreement workflow for permission delegation.
* Enhanced identity binding through CAWG Identity assertions.
* Added comprehensive validation algorithm with atomic policy expansion.
* Provided migration guide from Endorsement to ODRL model.
* **Endorsement Assertion deprecated** in favor of ODRL Permissions Assertion.
